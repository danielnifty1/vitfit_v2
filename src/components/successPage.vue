...
<template>
  <div class="grid grid-cols-1 md:pl-24 md:pr-24 place-items-center h-full ">
    <div  class="bg-[#FAF6FD0D] grid grid-cols-1 md:w-6/12 place-items-center md:p-10 p-10 mb-5 mt-5 space-y-5">
